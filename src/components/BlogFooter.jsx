...
export const BlogFooter = React.memo(() => (
  <footer className="w-full flex flex-col items-center justify-center py-8 bg-space-dark">
    <div className="flex items-center justify-center w-full max-w-6xl px-8">
      ...
      >
        <span>MIT License © 2025 Kirill Vasilev | be cooked but keep moving.</span>
        <SocialLink href="https://www.linkedin.com/in/vasilevkirill/" ariaLabel="LinkedIn">
        ...
        <SocialLink href="https://github.com/kirushavasilev" ariaLabel="GitHub">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="inline align-middle">
        ...
        <SocialLink href="mailto:kvasilev@berkeley.edu" ariaLabel="Email">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="inline align-middle">
