...
// Icons
const CalendarIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
);

const TimeIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
);
    ...
    <AnimatePresence mode="wait">
      ...
      >
        <div className="min-h-screen flex flex-col">
          <div className="flex-grow pt-24 sm:pt-32">
                    ...
                    <article className="w-full max-w-3xl">
                      ...
                      >
                        ...
                        <motion.h1 
                          ...
                          className="text-2xl sm:text-4xl font-bold text-white mb-4 font-palatino"
                        >
                          {post.title}
                        </motion.h1>
                        <motion.p 
                      ...
                      <motion.div 
                        ...
                        className="prose prose-invert prose-sm sm:prose-lg max-w-none mb-16"
                      >
                        <ReactMarkdown 
